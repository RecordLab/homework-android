...
import com.recordlab.dailyscoop.ui.profile.bookmark.ProfileBookmarkActivity
import com.recordlab.dailyscoop.ui.profile.display.DisplaySettingActivity
...
//                intent.data = MediaStore.Images.Media.EXTERNAL_CONTENT_URI
        ...
        // 화면 설정 버튼 클릭
        val viewDisplay = binding.viewDisplay
        viewDisplay.setOnClickListener {
            val intent = Intent(activity, DisplaySettingActivity::class.java)
            startActivity(intent)
            activity?.overridePendingTransition(R.anim.fade_in, R.anim.fade_out)
        }

        // 계정 버튼 클릭
        val accountBtnClicked = binding.viewAccount
        ...
        // 알림 버튼 클릭
        val noticeBtnClicked = binding.viewNotification
        ...
        // 잠금 버튼 클릭
        val lockBtnClicked = binding.viewLockSettingToggle
