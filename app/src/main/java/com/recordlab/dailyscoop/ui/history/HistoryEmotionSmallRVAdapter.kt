...
class HistoryEmotionSmallRVAdapter(val data: List<MutableList<String>>) : RecyclerView.Adapter<HistoryEmotionSmallRVAdapter.Viewholder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HistoryEmotionSmallRVAdapter.Viewholder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.rv_history_emotion_small, parent, false)
        return Viewholder(view)
    }

    override fun onBindViewHolder(holder: HistoryEmotionSmallRVAdapter.Viewholder, position: Int) {
